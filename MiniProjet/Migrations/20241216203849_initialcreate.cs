    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PiecesDeRechange", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PiecesDeRechange_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PiecesDeRechangeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionPieces", x => new { x.InterventionsId, x.PiecesDeRechangeId });
                    table.ForeignKey(
                        name: "FK_InterventionPieces_Interventions_InterventionsId",
                        column: x => x.InterventionsId,
                        principalTable: "Interventions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterventionPieces_PiecesDeRechange_PiecesDeRechangeId",
                        column: x => x.PiecesDeRechangeId,
                        principalTable: "PiecesDeRechange",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionPieces_PiecesDeRechangeId",
                table: "InterventionPieces",
                column: "PiecesDeRechangeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PiecesDeRechange_ArticleId",
                table: "PiecesDeRechange",
                column: "ArticleId");
